 ...
 */
@TableName("wangzhan")
public class WangzhanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public WangzhanEntity() {

	}

	public WangzhanEntity(T t) {
		try {
    ...
    public String toString() {
        return "Wangzhan{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", wangzhanName=" + wangzhanName +
            ", sexTypes=" + sexTypes +
            ", wangzhanIdNumber=" + wangzhanIdNumber +
            ", wangzhanPhone=" + wangzhanPhone +
            ", wangzhanPhoto=" + wangzhanPhoto +
