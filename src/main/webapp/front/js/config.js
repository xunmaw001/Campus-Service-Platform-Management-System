...
var indexNav = [
    ...
    {
        name: '教师办公电话',
        url: './pages/bangongdianhua/list.jsp'
    },
    {
        name: '餐饮信息',
        url: './pages/chanyinxinxi/list.jsp'
    },
    {
        name: '二手物品',
        url: './pages/ershouwupin/list.jsp'
    },
    {
        name: '失物招领',
    ...
    {
        name: '校车查询',
        url: './pages/xiaochechaxun/list.jsp'
    },
    {
        name: '新闻',
...
var adminurl =  "http://localhost:8080/xiaoyuanfuwupingtai/index.jsp";
