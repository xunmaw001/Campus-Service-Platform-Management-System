            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-en" aos="fade-up">NEWS SHOW</span>
                    </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">二手物品展示</span>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  ershouwupinList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../ershouwupin/detail.jsp?id='+item.id)">
                                            <img :src="item.ershouwupinPhoto?item.ershouwupinPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.ershouwupinName}}</p>
                                            <p style="color: red;" v-if="item.ershouwupinNewMoney">{{item.ershouwupinNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../ershouwupin/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">校车查询展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  xiaochechaxunList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../xiaochechaxun/detail.jsp?id='+item.id)">
                                            <img :src="item.xiaochechaxunPhoto?item.xiaochechaxunPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.xiaochechaxunName}}</p>
                                            <p style="color: red;" v-if="item.xiaochechaxunNewMoney">{{item.xiaochechaxunNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../xiaochechaxun/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">教师办公电话展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  bangongdianhuaList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../bangongdianhua/detail.jsp?id='+item.id)">
                                            <img :src="item.bangongdianhuaPhoto?item.bangongdianhuaPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.bangongdianhuaName}}</p>
                                            <p style="color: red;" v-if="item.bangongdianhuaNewMoney">{{item.bangongdianhuaNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../bangongdianhua/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">餐饮信息展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  chanyinxinxiList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../chanyinxinxi/detail.jsp?id='+item.id)">
                                            <img :src="item.chanyinxinxiPhoto?item.chanyinxinxiPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.chanyinxinxiName}}</p>
                                            <p style="color: red;" v-if="item.chanyinxinxiNewMoney">{{item.chanyinxinxiNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../chanyinxinxi/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  shiwuzhaolingList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../shiwuzhaoling/detail.jsp?id='+item.id)">
                                            <img :src="item.shiwuzhaolingPhoto?item.shiwuzhaolingPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.shiwuzhaolingName}}</p>
                                            <p style="color: red;" v-if="item.shiwuzhaolingNewMoney">{{item.shiwuzhaolingNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../shiwuzhaoling/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`ershouwupin/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.ershouwupinList = res.data.list;
        });
        ...
        http.request(`xiaochechaxun/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.xiaochechaxunList = res.data.list;
        });
        http.request(`bangongdianhua/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.bangongdianhuaList = res.data.list;
        });
        http.request(`chanyinxinxi/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.chanyinxinxiList = res.data.list;
        });
