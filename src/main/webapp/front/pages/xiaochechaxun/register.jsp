              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">校车编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xiaochechaxunName" id="xiaochechaxunName"  placeholder="校车编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">发车时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xiaochechaxunTime" id="xiaochechaxunTime"  placeholder="发车时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
