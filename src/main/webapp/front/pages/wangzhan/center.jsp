	...
	<body style="background: #EEEEEE;">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="wangzhanName" id="wangzhanName" lay-verify="required" placeholder="网站管理员姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="wangzhanIdNumber" id="wangzhanIdNumber"  lay-verify="required|identity"   placeholder="身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="wangzhanPhone" id="wangzhanPhone"  lay-verify="required|phone"   placeholder="手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="wangzhanPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="wangzhanPhoto" name="wangzhanPhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`wangzhan/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#wangzhanPhotoImg").attr("src", data.data.wangzhanPhoto);
                });
