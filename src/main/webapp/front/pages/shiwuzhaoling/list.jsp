                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../shiwuzhaoling/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.shiwuzhaolingPhoto?item.shiwuzhaolingPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../shiwuzhaoling/detail.jsp?id='+item.id)"><span>{{item.shiwuzhaolingName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.shiwuzhaolingNewMoney"><span style="color: red;">{{item.shiwuzhaolingNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shiwuzhaolingContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shiwuzhaolingContent: function(val) {
                if (val) {
