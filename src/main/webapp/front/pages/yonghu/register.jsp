...
<!-- 身份证号 -->
  ...
  <!-- 邮箱 -->
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">专业班级:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuBanjiZhuanye" id="yonghuBanjiZhuanye"  placeholder="专业班级"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
