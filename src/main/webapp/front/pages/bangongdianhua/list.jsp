                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="bangongdianhuaName" id="bangongdianhuaName" placeholder="教师名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">教师部门</label>
                          <div class="layui-input-inline">
                              <select name="bangongdianhuaTypes" id="bangongdianhuaTypes" lay-filter="bangongdianhuaTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in bangongdianhuaTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../bangongdianhua/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.bangongdianhuaPhoto?item.bangongdianhuaPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../bangongdianhua/detail.jsp?id='+item.id)"><span>{{item.bangongdianhuaName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.bangongdianhuaNewMoney"><span style="color: red;">{{item.bangongdianhuaNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            bangongdianhuaTypesList : [],
            sexTypesList : [],
            bangongdianhuaTypes: 1,//类型
            limit: 10,
        ...
        filters: {
            //把 bangongdianhuaContent 字段去除无用字符 如果字段长度大于60  就截取到60
            bangongdianhuaContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#bangongdianhuaName').val() != null && jquery('#bangongdianhuaName').val() != "" && jquery('#bangongdianhuaName').val() != "null" ) {
                param['bangongdianhuaName'] = jquery('#bangongdianhuaName').val();
            }
         
            var bangongdianhuaTypes = $("#bangongdianhuaTypes").find("option:selected").val();
            if (bangongdianhuaTypes != null && bangongdianhuaTypes != "" && bangongdianhuaTypes != "null") {
                param['bangongdianhuaTypes'] = bangongdianhuaTypes;
            }
            ...
            if (sexTypes != null && sexTypes != "" && sexTypes != "null") {
                param['sexTypes'] = sexTypes;
                                            ...
                                            // 获取列表数据
            http.request('bangongdianhua/list', 'get', param, function(res) {
    ...
    // 当前表的字典表
       ...
       function bangongdianhuaTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=bangongdianhua_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.bangongdianhuaTypesList = res.data.list;
               }
           });
       }
