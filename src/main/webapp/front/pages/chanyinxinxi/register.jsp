                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="chanyinxinxiName" id="chanyinxinxiName"  placeholder="菜品名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="chanyinxinxiMoney" id="chanyinxinxiMoney"  lay-verify="double|required"   placeholder="菜品价格" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
